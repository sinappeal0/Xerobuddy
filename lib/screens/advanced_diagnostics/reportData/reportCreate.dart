...
Future<Uint8List> makeReport() async {
  final pdf = Document();
              ...
              children: [
                Column(
                    ...
                    children: [
                      ...
                      Text("Schirmer Test : $schirmer", style: TextStyle(font: fontRegular, fontSize: 14,),),
                      SizedBox(height: 2),

                      Text("USFR Test : $usfr", style: TextStyle(font: fontRegular, fontSize: 14,),),
                      SizedBox(height: 2),
                    ]
                ),
                Column(
