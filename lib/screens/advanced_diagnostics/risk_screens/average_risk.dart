...
import '../reportData/reportPreview.dart';

class AverageRisk extends StatefulWidget {
  const AverageRisk({super.key});

  @override
  State<AverageRisk> createState() => _AverageRiskState();
}

class _AverageRiskState extends State<AverageRisk> {
