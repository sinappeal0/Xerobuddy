...
class PatientLowRisk extends StatefulWidget {
  const PatientLowRisk({super.key});

  @override
  State<PatientLowRisk> createState() => _PatientLowRiskState();
}

class _PatientLowRiskState extends State<PatientLowRisk> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // Drug Lists
                    Text("No Drugs Recommended", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.black54),),
                    const SizedBox(height: 10,),
