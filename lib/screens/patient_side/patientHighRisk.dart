...
class PatientHighRisk extends StatefulWidget {
  const PatientHighRisk({super.key});

  @override
  State<PatientHighRisk> createState() => _PatientHighRiskState();
}

class _PatientHighRiskState extends State<PatientHighRisk> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 180,
                      child: Image.asset("assets/images/redlight 1.png"),
                    ),
                    const SizedBox(height: 40,),

                    Text("High Risk", style: GoogleFonts.poppins(fontWeight: FontWeight.w700, color: Colors.black, fontSize: 28), textAlign: TextAlign.center,),
                    const SizedBox(height: 20,),
